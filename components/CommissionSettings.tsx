...
export function CommissionSettings({ abaInicial = 'usuarios' }: CommissionSettingsProps = {}) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* =========================================================================
          SUB-TAB 5: DDL & STORED PROCEDURE EM SQL
          ========================================================================= */}
      {subAba === 'sql_ddl' && (
        <div className="space-y-4">
          <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-2xs">
            <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
              ...
              <div>
                <h2 className="text-sm font-bold text-slate-900">
                  Mapeamento dos Parâmetros no PostgreSQL PL/pgSQL
                </h2>
                <p className="text-[11px] text-slate-500">
                  Estrutura relacional do banco de dados para persistência e cálculo em Stored Procedure
                </p>
              </div>
            </div>
            ...
            <div className="mt-4 space-y-4">
              <div className="rounded-xl bg-slate-900 p-4 font-mono text-xs text-slate-200 shadow-inner">
                <div className="text-slate-400 text-[11px] mb-2 pb-2 border-b border-slate-800">
                  -- Tabela de Regras e Versionamento com Vigência
                </div>
...
{`CREATE TABLE IF NOT EXISTS regras_comissao_vendedor (
    ...
    tipo_comissao tipo_comissao_enum NOT NULL, -- 'ESCALONADO_ENTRADA' ou 'VALOR_FIXO'
    valor_fixo NUMERIC(12,2) DEFAULT 0.00,
    vigencia_inicio DATE NOT NULL,
    vigencia_fim DATE, -- NULL indica vigência por prazo indeterminado
    criado_em TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT chk_vigencia CHECK (vigencia_fim IS NULL OR vigencia_fim >= vigencia_inicio)
);

CREATE TABLE IF NOT EXISTS faixas_comissao_entrada (
    ...
    percentual_comissao NUMERIC(5,2) NOT NULL     -- Alíquota aplicada sobre o total da venda
);`}
                </pre>
              </div>
            </div>
      ...
      {/* =========================================================================
          SUB-TAB 7: IDENTIDADE VISUAL & LOGOTIPO DA EMPRESA
          ========================================================================= */}
      {subAba === 'identidade_visual' && (
