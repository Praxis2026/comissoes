...
SELECT 'e0000000-0000-0000-0000-000000000001', 30.00, NULL, 1.00
WHERE NOT EXISTS (SELECT 1 FROM faixas_entrada_comissao WHERE regra_id = 'e0000000-0000-0000-0000-000000000001' AND percentual_entrada_min = 30.00);

INSERT INTO faixas_entrada_comissao (regra_id, percentual_entrada_min, percentual_entrada_max, percentual_comissao)
SELECT 'e0000000-0000-0000-0000-000000000001', 10.00, 29.99, 0.50
WHERE NOT EXISTS (SELECT 1 FROM faixas_entrada_comissao WHERE regra_id = 'e0000000-0000-0000-0000-000000000001' AND percentual_entrada_min = 10.00);

INSERT INTO faixas_entrada_comissao (regra_id, percentual_entrada_min, percentual_entrada_max, percentual_comissao)
SELECT 'e0000000-0000-0000-0000-000000000002', 30.00, NULL, 1.00
WHERE NOT EXISTS (SELECT 1 FROM faixas_entrada_comissao WHERE regra_id = 'e0000000-0000-0000-0000-000000000002' AND percentual_entrada_min = 30.00);

INSERT INTO faixas_entrada_comissao (regra_id, percentual_entrada_min, percentual_entrada_max, percentual_comissao)
SELECT 'e0000000-0000-0000-0000-000000000002', 10.00, 29.99, 0.50
WHERE NOT EXISTS (SELECT 1 FROM faixas_entrada_comissao WHERE regra_id = 'e0000000-0000-0000-0000-000000000002' AND percentual_entrada_min = 10.00);
